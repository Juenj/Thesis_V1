...
def most_similar_with_wasserstein_closed_interval(relevant_index, relevant_df, weighting_function, steps = 12, normalizing_factor = 11, max_weight = 1,interval_steps=10):
    ...
    #####
    identified_situation_weights_start = calculate_weights(identified_corner_start_df,normalizing_factor, fun = weighting_function, max_val=max_weight)
    identified_situation_weights_stop = calculate_weights(identified_corner_stop_df,normalizing_factor, fun = weighting_function, max_val=max_weight)
